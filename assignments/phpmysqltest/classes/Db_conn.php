...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'sgm114';//this will be your WCC username
      $dbUsr = 'sgm114';//this will be your WCC username
      $dbPass = 'ffwYdY9rXGRv';//this will be the password found in the video.
